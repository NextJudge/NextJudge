...
# Prints the Coolify preview URL for a PR-scoped web or docs deployment.
# Usage: preview-url.sh <web|docs> [PR_NUMBER]

SERVICE="${1:?usage: preview-url.sh <web|docs> [PR_NUMBER]}"
