...
<html lang="en">
  <head>
    ...
    <style>
      ...
      #scalar-docs { min-height: 100vh; }
      #scalar-docs:empty::before {
        color: #8b8b8b;
  ...
  <body>
    ...
    <script>
      if (!window.location.hash) {
        window.history.replaceState(null, '', window.location.pathname + window.location.search + '#description/introduction');
      }
    </script>
