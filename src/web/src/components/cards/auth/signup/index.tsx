...
interface GitHubFirstSignUpCardProps extends SignUpCardProps {
  ...
  return (
    <Card className="mt-20">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          {allowBasicRegistration
            ? SITE_COPY.signUpCardDescription
            : "Create your NextJudge account securely with GitHub."}
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="grid gap-4">
        ...
        {allowBasicRegistration ? (
          ...
          <p className="text-center text-sm text-muted-foreground">
            Email registration is unavailable. Existing email accounts can
            still sign in.
          </p>
        )}
        <p className="text-center text-sm text-muted-foreground">
