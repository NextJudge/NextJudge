      ...
      <TooltipProvider>
        <div className="text-center space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium font-sans">
            Run competitive programming <br /> contests
          ...
          <p className="text-muted-foreground max-w-sm md:max-w-xl font-normal mx-auto mt-2">
            What started as a way for <span className="text-osu">ACM@OSU</span> to practice for ICPC, is now a fully-featured platform to host, judge, and compete in programming contests.
          </p>
          <HeroButtons />
        </div>
      </TooltipProvider>
